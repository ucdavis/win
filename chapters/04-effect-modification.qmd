...
The **conditional average treatment effect** (CATE) in the subpopulation with $V = v$ is $\E{Y^{a=1} - Y^{a=0} | V = v}$.
:::
...
::: {#def-confounding-vs-modification-distinction}
## Confounding as Bias, Effect Modification as Finding
...
**Matching** creates treatment and control groups that are similar with respect to measured covariates $L$.
:::
...
::: {#def-statistical-interaction-vs-effect-modification}
## Statistical Interaction vs. Effect Modification
