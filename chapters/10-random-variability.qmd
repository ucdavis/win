...
Up to now, we have focused on identification. Now we turn to estimation.

::: {#def-identification-vs-estimation}
## Identification and Estimation

**Identification**: determining whether causal effects can be computed from observed data under certain assumptions.

**Estimation**: using finite data to approximate those causal effects.
:::

### Key Concepts in Statistical Estimation

::: {#def-estimand-estimator-estimate}
...
::: {#def-calibrated-valid-intervals}
## Calibrated, Conservative, and Valid Intervals
