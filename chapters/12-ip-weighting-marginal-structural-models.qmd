...
4. Still create pseudo-population with $A \perp\!\!\!\perp L$
...
1. **Treatment**: $Y^a \perp\!\!\!\perp A \mid L$ (conditional exchangeability)
2. **Censoring**: $C \perp\!\!\!\perp Y^a \mid A, L$ (missing at random)
